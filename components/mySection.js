export default{
    ...
    listTitleSection(){
        ...
        <article class="blog-post" id="Content">
          <h2 class="blog-post-title">${this.title.history}</h2>

          <p>${this.title.paragraph1}</p>
          <hr>
          <p>${this.title.paragraph2}</p>
        </article>
        `
         )
        },
        listPeriods(){
            ...
            document.querySelector("#Content").insertAdjacentHTML("beforeend", plantilla);
        },
        listTableDisco(){
            document.querySelector("#section").insertAdjacentHTML("beforeend", 
            `
            <article class="blog-post">
                <h2 class="blog-post-title">${this.title.section2}</h2>
                <p class="blog-post-meta">Un vistazo a las producciones de la banda</p>

                <p>${this.title.paragraph3}</p>
